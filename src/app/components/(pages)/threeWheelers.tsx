...
const ThreeWheelers = () => {
    ...
    const faqData = [
        { title: 'What are the best Heavy commercial vehicles In India?', content: 'Ashok Leyland AVTR 2820-6x4, Tata Signa 5530.S, Tata Signa 3523.TK, Tata Signa 1923.K and Tata Signa 4018.S & many more are popular Medium & Heavy trucks in India with starting price at Rs ₹6.78 Lakh.' },
        { title: 'What are the latest MHCVs in India?', content: 'The latest Medium & Heavy commercial vehicles in India are Tata Prima 4040.K,I-BOARD Tipper Elecy V3525,I-BOARD Ductor 5525,I-BOARD Long Haulage TT 5520,I-BOARD REX 5525 & more.' },
        { title: "What are the popular MHCVs manufacturers in India?", content: (<>The popular Heavy commercial vehicle manufacturers are <span className='text-blue-400'>Tata,Ashok Leyland,Mahindra</span> & more in India.</>) }
    ];
